...
var win = new Window('dialog', '裁剪工具 \u00A9 www.ladyginpro.ru', undefined);
...
var panel = globalGroup.add('panel', undefined, '画板');
...
var activeArtboardRadio = groupRadio.add('radiobutton', undefined, '当前'),
    allArtboardsRadio = groupRadio.add('radiobutton', undefined, '全部'),
    customArtboardsRadio = groupRadio.add('radiobutton', undefined, '自定义');
...
var extraPanel = globalGroup.add('panel', undefined, '项目: 栅格, 置入, 网格');
    extraPanel.orientation = 'column';
    extraPanel.alignChildren = 'fill';
    extraPanel.margins = [20, 20, 20, 10];

var isRPM = extraPanel.add('checkbox', undefined, '启用裁剪项目');
    isRPM.value = true;
...
var cropRPM = RPMGroup.add('radiobutton', undefined, '裁剪'),
    maskRPM = RPMGroup.add('radiobutton', undefined, '剪切蒙版');
    cropRPM.value = true;
...
var resolutionList = resGroup.add('dropdownlist', [0, 0, 120, 25], ['屏幕 (72 ppi)', '中等 (150 ppi)', '高 (300 ppi)', '使用文档栅格效果分辨率', '其他']),
...
var includeHLI = globalGroup.add('checkbox', undefined, '包括隐藏和锁定项目');
    includeHLI.value = true;

var onlySelection = globalGroup.add('checkbox', undefined, '仅裁剪选中项');
...
var cancel = winButtons.add('button', [0, 0, 30, 25], '取消');
    cancel.helpTip = '按Esc关闭';
    cancel.onClick = function () { win.close(); }

var ok = winButtons.add('button', undefined, '开始裁剪');
    ok.helpTip = '按Enter运行';
